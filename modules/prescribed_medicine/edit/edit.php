<?php
class Prescribed_medicineEdit extends MY_Controller
{
    ...
    public function getPrescribed_medicineEdit()
    {
        ...
        if($this->session->userdata('logged_in')) {
            ...
            $this->template = 'user/order/prescribed_medicine/edit/edit';
        }
    }

    public function postPrescribed_medicineEdit()
    {
        $id = $this->uri->segment(4);
        if($this->session->userdata('logged_in')) {
            $this->template = 'cms/prescribed_medicine/edit/edit';
