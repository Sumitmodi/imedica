...
<!--            </div>-->
            ...
            <div class="form-group">
                <label class="col-md-3 control-label" for="faq_question">Question</label>
                <div class="col-md-9">
            ...
            <div class="form-group">
                <label class="col-md-3 control-label" for="faq_answer">Answer</label>
                <div class="col-md-9">
                    <textarea id="description" rows="3" cols="47" name="faq_answer" class="form-control" placeholder="Enter Answer" ></textarea>
                </div>
            </div>

            <div class="form-group">
                <label class="col-md-3 control-label" for="faq_date">Date</label>
                <div class="col-md-9">
