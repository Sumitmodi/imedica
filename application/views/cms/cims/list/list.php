            ...
            {?>
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="#modal-fade" title="view_cims" class="btn btn-effect-ripple btn-xs btn-info view-modal" data-toggle="modal" data-name="<?php echo $row->Medicine_name;?>" data-category="<?php echo $cat['0']->category_name;?>" data-composition="<?php echo $row->Composition;?>" data-id="<?php echo $row->id;?>" data-dose="<?php echo $row->Dose;?>">
                                <i class="fa fa-eye"></i>
                            </a>
                            <a href="<?php echo base_url('admin/cims/edit/'.$row->id);?>" data-toggle="tooltip" title="edit_cims" class="btn btn-effect-ripple btn-xs btn-success"><i class="fa fa-pencil"></i></a>
                            <a href="#" data-href="<?php echo base_url('admin/cims/delete/'.$row->id);?>" data-toggle="modal" data-name="<?php echo $row->Medicine_name;?>" title="delete_cims" data-target="#confirm-delete" class="btn btn-effect-ripple btn-xs btn-danger del-row"><i class="fa fa-times"></i></a>
                        </td>
                    </tr>
                </div>
            <?php } ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title"><strong>CIMS Details</strong></h3>
            </div>
