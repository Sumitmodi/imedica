        ...
        <table id="example-datatable" class="table table-bordered table-vcenter">
            ...
            <tr>
                ...
                <td class="text-center">
                    ...
                    <a href="<?php echo base_url('admin/patient/edit/'.$row->id);?>" data-toggle="tooltip" title="edit_patient" class="btn btn-effect-ripple btn-xs btn-success"><i class="fa fa-pencil"></i></a>
                    <a href="#" data-href="<?php echo base_url('admin/patient/delete/'.$row->id);?>" data-toggle="modal" data-name="<?php echo $row->patient?>" title="delete_patient" data-target="#confirm-delete" class="btn btn-effect-ripple btn-xs btn-danger del-row"><i class="fa fa-times"></i></a>
                </td>
            </tr>
    </div>
<?php } ?>
