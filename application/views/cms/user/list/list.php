        ...
        <table id="example-datatable" class="table table-bordered table-vcenter">
            ...
            <tr>
                ...
                <td class="text-center">
                    <a href="#modal-fade" title="view_user" class="btn btn-effect-ripple btn-xs btn-info view-modal" data-toggle="modal" data-name="<?php echo $row->name;?>" data-location="<?php echo $row->location;?>" data-phone="<?php echo $row->phone_no;?>" data-id="<?php echo $row->id;?>" data-email="<?php echo $row->email;?>" data-status="<?php echo $row->status;?>">
                        <i class="fa fa-eye"></i>
                    </a>
                    <a href="<?php echo base_url('admin/user/edit/'.$row->id);?>" data-toggle="tooltip" title="edit_user" class="btn btn-effect-ripple btn-xs btn-success"><i class="fa fa-pencil"></i></a>
                    <a href="#" data-href="<?php echo base_url('admin/user/delete/'.$row->id);?>" data-toggle="modal" data-name="<?php echo $row->name;?>" title="delete_user" data-target="#confirm-delete" class="btn btn-effect-ripple btn-xs btn-danger del-row"><i class="fa fa-times"></i></a>
                </td>
            </tr>
    </div>
<?php } ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title"><strong>User Details</strong></h3>
            </div>
