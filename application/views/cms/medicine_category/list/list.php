        ...
        <table id="example-datatable" class="table table-bordered table-vcenter">
            ...
            <tr>
                ...
                <td class="text-center">
                    <a href="<?php echo base_url('admin/medicine_category/edit/'.$row->id);?>" data-toggle="tooltip" title="edit_category" class="btn btn-effect-ripple btn-xs btn-success"><i class="fa fa-pencil"></i></a>
                    <a href="#" data-href="<?php echo base_url('admin/medicine_category/delete/'.$row->id);?>" data-toggle="modal" data-name="<?php echo $row->category_name;?>" title="delete_category" data-target="#confirm-delete" class="btn btn-effect-ripple btn-xs btn-danger del-row"><i class="fa fa-times"></i></a>
                </td>
            </tr>
    </div>
<?php } ?>
