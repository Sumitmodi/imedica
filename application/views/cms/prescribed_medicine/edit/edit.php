            ...
            <form id="clickable-wizard" action="" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                <input type="text" id="disease" name="disease" class="form-control"
                                       placeholder="Enter Disease" value="<?php echo $query[0]->disease; ?>" required>
                ...
                <div id="clickable-third" class="step">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" id="prescribed_by" value="<?php echo $query[0]->prescribed_by;?> " name="prescribed_by" class="form-control"/>
                        </div>
                    </div>
