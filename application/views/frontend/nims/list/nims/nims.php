            ...
            <div class="mid-widgets-serices col-xs-12 col-sm-12 col-md-12 col-lg-12 no-pad pull-left services-page">
                <?php foreach($nims as $n){?>
                    <div class="col-sm-5 col-xs-12 col-md-3 col-lg-3 service-box no-pad wow fadeInLeft animated" data-wow-delay="1s" data-wow-offset="150">
                        <div class="service-title"><div class="service-icon-container rot-y"><i class="icon-medkit panel-icon"></i></div><?php echo $n['Medicine_name'];?></div>
                        <p>Category : <?php echo $n['category_name'];?><br>
                            Composition : <?php echo $n['Composition'];?></p>
                    </div>
                <?php } ?>
            </div>
