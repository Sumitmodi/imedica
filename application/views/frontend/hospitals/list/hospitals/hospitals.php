<?php
$hosp_slice = array_slice($hospitals,0,4);
?>
            ...
            <div class="content-tabs tabs col-xs-12 col-sm-12">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade fade-slow in active" id="all-doc">
                        ...
                        <?php } ?>
                        <div class="col-sm-12"><a href="<?php echo base_url().'allhospitals';?>" class="dept-details-butt posts-showall">Show All</a></div>
                    </div><!--sub col-md-8 end-->
