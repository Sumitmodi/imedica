...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/css/google/style.css"/>
    <link rel="stylesheet" media="screen and (max-width: 1200px) and (min-width: 0px)" type="text/css" href="<?php echo base_url();?>assets/css/google/styleresponsive1.css"/>
    <link rel="stylesheet" media="screen and (max-width: 600px) and (min-width: 0px)" type="text/css" href="<?php echo base_url();?>assets/css/google/styleresponsive2.css"/>
</head>
<body>
<div id="main">
    <div id="envelope">
        <?php if (isset($authUrl)){ ?>
            ...
            <hr>
            <div id="content">
                <center><a href="<?php echo $authUrl;?>"><img id="google_signin" src="<?php echo base_url();?>assets/img/google_login.gif" width="50%"></a></center>
            </div>
        <?php } else { ?>
            <header id="info">
